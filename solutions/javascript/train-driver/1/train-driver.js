 ...
 */
export function getListOfWagons(...wagonsID) {
  return wagonsID;
}
...
export function fixListOfWagons(ids) {
  const [a,b,...wagonsId] = ids;
  const data = [...wagonsId, a, b];
  return data
}
...
export function correctListOfWagons(ids, missingWagons) {
  console.log(missingWagons)
  const [a, ...wagonsId] = ids;
  const [...missingWagonsId] = missingWagons;
  const data = [a, ...missingWagonsId, ...wagonsId];
  return data;
}
...
export function extendRouteInformation(information, additional) {
  const {...route} = information;
  const {...moreRouteInf} = additional
  const data = {...route, ...moreRouteInf}
  return data;
}
